...
var lexTests = []lexTest{
	...
	{"text with link", "hello-[[blah]]-world", []item{
		{itemText, 0, "hello-"},
		{itemLinkLeftDelimiter, 0, "[["},
		{itemLinkLocationInternal, 0, "blah"},
		{itemLinkRightDelimiter, 0, "]]"},
		{itemText, 0, "-world"},
		tEOF,
	}},
	...
	{"text with link", "hello- [[http://www.blah.com/whatever?asdf]], -world", []item{
		{itemText, 0, "hello- "},
		{itemLinkLeftDelimiter, 0, "[["},
		{itemLinkLocation, 0, "http://www.blah.com/whatever?asdf"},
		{itemLinkRightDelimiter, 0, "]]"},
		{itemText, 0, ", -world"},
		tEOF,
	}},
	...
	{"text with link", "hello- [[somepage|blah whatever]], -world", []item{
		{itemText, 0, "hello- "},
		{itemLinkLeftDelimiter, 0, "[["},
		{itemLinkLocationInternal, 0, "somepage"},
		{itemLinkDelimiter, 0, "|"},
		{itemLinkText, 0, "blah whatever"},
		{itemLinkRightDelimiter, 0, "]]"},
		{itemText, 0, ", -world"},
